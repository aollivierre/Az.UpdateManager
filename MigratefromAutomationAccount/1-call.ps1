# & "C:\Code\CB\Azure\[customer]\1-Migrate-From-UpdateManager.ps1" -AutomationAccountResourceId "/subscriptions/[AzSubID]/resourceGroups/defaultresourcegroup-cus/providers/Microsoft.Automation/automationAccounts/Automate-[AzSubID]-CUS
# AzureCloud" -$AutomationAccountAzureEnvironment "AzureCloud"


# & "C:\Code\CB\Azure\[customer]\1-Migrate-From-UpdateManager.ps1" -AutomationAccountResourceId "/subscriptions/{subId}/resourceGroups/{rgName}/providers/Microsoft.Automation/automationAccounts/{aaName}" -AutomationAccountAzureEnvironment "AzureCloud"
